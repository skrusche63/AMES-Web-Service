 ...
 *
 * <SemanticAssist>
 *     #domain #function #image #json #model #web
 * </SemanticAssist>
 *
 */
...
public class JsonImage extends JsonExtrinsicObject {
	 ...
	 * @param jaxrHandle
	 */
	public JsonImage(JaxrHandle jaxrHandle) {
		super(jaxrHandle);
	}
    ...
    public void set(RegistryObjectImpl ro, Locale locale) throws JSONException, JAXRException {    
    	 ...
    	 * Convert icon
    	 */
    	put(JaxrConstants.RIM_ICON, IconConstants.IMAGE);
